...
namespace Qx.Account.Alipay
{
    ...
    public class Submit
    {
        ...
        //商户的私钥
        private static string _private_key = Config.private_key;
        //编码格式
        private static string _input_charset = Config.input_charset;
        //签名方式
        private static string _sign_type = Config.sign_type;
        #endregion
