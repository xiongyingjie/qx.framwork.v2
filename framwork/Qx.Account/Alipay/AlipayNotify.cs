...
namespace Qx.Account.Alipay
{
    ...
    {
        #region 字段
        private string _partner =Config.partner;               //合作身份者ID
        private string alipay_public_key =Config.alipay_public_key;            //支付宝的公钥
        private string _input_charset = Config.input_charset;         //编码格式
        private string _sign_type = Config.sign_type;             //签名方式
