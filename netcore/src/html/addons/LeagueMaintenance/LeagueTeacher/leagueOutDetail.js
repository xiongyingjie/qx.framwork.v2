...
showInput('迁出申请时间', 'emigrationapply-apply_time', '', '4'),
showTime('迁出时间', 'emigrationapply-emigration_time', '', '4'),
showInput('当前单位', 'emigrationapply-current_organization', '', '4'),
showInput('迁出到单位', 'emigrationapply-emigrate_to_organization', '', '2'),
showInput('迁出操作人', 'emigrationapply-emigration_operator', '', '2'),
