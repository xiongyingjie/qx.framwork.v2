...
hide('coacher_activity-state_id', ''),  //审核状态0未通过1通过
...
showInput('活动标题', 'coacher_activity-name', '', '4', { min: 1, max: 50 }),
showInput('地址', 'coacher_activity-address', '', '4', { min: 1, max: 50 }),
showInput('活动价格', 'coacher_activity-price', '', '4', { float: true }),
showInput('承办单位', 'coacher_activity-host_unit', '', '4'),
showSelect("报名方式", "coacher_activity-sign_mode", [{ value: "个人", text: "个人" }, { value: "团体", text: "团体" }], "个人", 4),

showInput('备注', 'coacher_activity-note', '', '4'),
hide('coacher_activity-is_enable', '1'),  //是否启用0为禁用1为启用
showTime('报名开始时间', 'coacher_activity-sign_begin_time', '', '4', '请选择报名开始时间'),
showTime('报名结束时间', 'coacher_activity-sign_end_time', '', '4', '请选择报名结束时间'),
showfile('图片', 'coacher_activity-photos'),
editor('活动介绍', 'coacher_activity-detail')

     ], '活动详情')], '', 'wx.sports.coacher_activity@find&id=' + q.id, '', '详情');