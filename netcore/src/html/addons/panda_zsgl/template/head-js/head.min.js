//{app_name}
//{host}https://api.52xyj.cn
//{cdn}https://cdn.52xyj.cn/xyj.framwork
//{host_sys}https://api.52xyj.cn
//{host_wx}http://api.52xyj.cn
/*! head.load - v1.0.3 */
...
var g_pcroot = "/addons/panda_zsgl/template";//注意末尾不能有/
var g_approot = "/addons/panda_zsgl/template";//注意末尾不能有/
var _c = {
    security: {
        encrypt_key: "xyj",
        decrypt_key: "xyj",
