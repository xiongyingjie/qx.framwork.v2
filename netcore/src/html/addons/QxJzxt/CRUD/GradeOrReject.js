...
render(
    function () {
        ...
        if (model.data.mark == "" || model.data.mark == null) {
            groupContent3.push(button("评分", '1:5', Color.green, function () {
                submitForm("/QxJzxt/CRUD/AwardExamineDetail?flag=2&premark=1");
            }));
        } else {
            groupContent3.push(button("评分", '1:5', Color.green, function () {
                submitForm("/QxJzxt/CRUD/AwardExamineDetail?flag=2&premark=2");
            }));
        }

        groupContent3.push(button("驳回", '6:0', Color.orange, function () {
            submitForm("/QxJzxt/CRUD/AwardExamineDetail?flag=3");
        }));
