...
input('发票类型', 'customer-tickect_type', '', '4', {min:1,max:50}),
...
input('客户分类', 'customer-customer_type', '', '4', {min:1,max:50}),
...
return cfg;
},'erp.invoicing.customer@update&id='+q.id,'erp.invoicing.customer@find&id='+q.id,'编辑');