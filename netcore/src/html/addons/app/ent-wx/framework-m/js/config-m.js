...
g_host_wx = g_host;
g_homepage = "/web/app/ent-wx/index.html";//var g_homepage = "/pages/index.html";
...
//微信授权;后面的参数是subSystem
  g_wx = g_wx_login ? (g_host_wx + "/WeChat/EntWeb/Authorize?return_url=" + window.location.origin + g_login_wx + "?subSystem=ent_wx") : "";
