...
g_framwork_dir = "/web/app/ent-wx/framework-m/";
g_host_wx = g_host;
g_homepage = "/web/app/ent-wx/contact/index.html";//var g_homepage = "/pages/index.html";
...
g_withdraw_wx = g_framwork_dir + "-withdraw.html";//提现
  ...
  g_pay_result_wx = window.location.origin +g_charge_result_wx+ "?subSystem=sports";
//微信授权回调
  g_login_wx = g_framwork_dir+"login-wx.html";
//微信授权;后面的参数是subSystem
  g_wx = g_wx_login ? (g_host_wx + "/WeChat/EntWeb/Authorize?return_url=" + window.location.origin + g_login_wx + "?subSystem=sports") : "";
