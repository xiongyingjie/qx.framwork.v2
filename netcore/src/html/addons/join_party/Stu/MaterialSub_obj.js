...
render(function () {
    return [
		group([//入党联系人，入党志愿书上传
            //-----------------------------------------------------------
			file('上传入党志愿书', 'cultivation_object_info-join_party_volunte', 1, "/UserFile/join_party/formal_application_file/"),
...
button("提交材料", '1:5', Color.green, function () {
      ...
      $("#cultivation_object_info-sub_time_of_vlolunte").val("#now");
