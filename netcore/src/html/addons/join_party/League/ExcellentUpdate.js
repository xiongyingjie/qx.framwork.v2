...
cfg.push(
    group([
input('uid', 'cultivation_object_info-uid', '', '4', {min:1,max:50}),
input('学号', 'cultivation_object_info-stu_Id', '', '4', {min:1,max:50}),
input('姓名', 'cultivation_object_info-name', '', '4', {min:1,max:50}),
input('班级', 'cultivation_object_info-Class', '', '4', {min:1,max:50}),
time('递交入党申请书时间', 'cultivation_object_info-join_application_time', '', '4', '请选择递交入党申请书时间'),
input('性别', 'cultivation_object_info-sex', '', '4', {min:1,max:20}),
input('民族', 'cultivation_object_info-natiion', '', '4', {min:1,max:50}),
input('年级', 'cultivation_object_info-Grade', '', '4', {min:1,max:50}),
time('出生年月', 'cultivation_object_info-birthday', '', '4', '请选择出生年月'),
input('电话', 'cultivation_object_info-phone', '', '4', {min:1,max:50}),
...
file('入党申请书', 'cultivation_object_info-join_application')
],'标题'));
return cfg;
