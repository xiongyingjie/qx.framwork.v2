...
input('#', 'cultivation_object_info-Grade', '', '4', {min:1,max:50}),
input('#', 'cultivation_object_info-name', '', '4', {min:1,max:50}),
input('#', 'cultivation_object_info-sex', '', '4', {min:1,max:20}),
input('民族', 'cultivation_object_info-natiion', '', '4', {min:1,max:50}),
time('#', 'cultivation_object_info-birthday', '', '4', '请选择#'),
input('#', 'cultivation_object_info-phone', '', '4', {min:1,max:50}),
...
],'标题')],'ecampus.join_party.cultivation_object_info@add','','添加');