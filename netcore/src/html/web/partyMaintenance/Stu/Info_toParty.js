...
render([
    group([
        ...
        file("上传介绍信", "Requst_table-intro_file", 1, "/UserFile/join_party/intro_file/"),
//---------------------------查出stu_info表中的列----------------
...
//---------------------------提交数据-----------------------------
         ...
         button("提交材料", '1:5', Color.green, function () {
             ...
             $("#cultivation_object_info-cultivation_object_stateId").val("5");
             ...
             submitForm("ecampus.join_party.cultivation_object_info@add|Requst_table@add");
         })
