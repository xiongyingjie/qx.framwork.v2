...
cfg.push(
    group([
hide('volunteer_member-vid', '', '4', {min:1,max:50}),
hide('volunteer_member-member_apply_id', '', '4', {min:1,max:50}),
hide('volunteer_member-activity_id', '', '4', {min:1,max:50}),
file('志愿服务总结文件', 'volunteer_member-volunteer_file'),
area('总结与评价', 'volunteer_member-score')
],'标题'));
return cfg;
