...
namespace xyj.core.Services
{
    public class ReportServices : IReportServices
    {
        ...
        private List<List<string>> _dbDataSource(ReportModel report, string parms, string dbConnStringKey, int pageIndex , int perCount)
        {
            ...
            var connStr = DbUtility.SqlSeverConnString(dbConnStringKey);
     ...
     VALUES
           ...
           ,'{7}')", model.ReportID.Replace("'", "''"),
            ...
            return sql.ExecuteNonQuery(_reportRuleConnectionString) > 0;
        }
        ...
        public ReportModel GetReprot(string id)
        {
            ...
            return ReportModel.ToReport(sql.ExecuteReader2(_reportRuleConnectionString));
        }
