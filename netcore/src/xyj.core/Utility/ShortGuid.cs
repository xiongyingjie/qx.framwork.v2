...
namespace xyj.core.Utility
{
    ...
    public struct ShortGuid
    {
        ...
        public static string Encode(string guidString)
        {
        ...
        public static string Encode(Guid guid)
        {
            ...
            return ToBase32String(guidBytes);
        }
        ...
        public static string Decode(string shortGuidString)
        {
            var guidBytes = FromBase32String(shortGuidString);
