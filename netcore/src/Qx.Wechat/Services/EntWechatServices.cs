...
namespace qx.wechat.Services
{
    ...
    public  class EntWechatServices : BaseRepository, IEntWechatServices
    {
        ...
        public string ApiHttpGet(string host, string url, Dictionary<string, object> param, string logFileName = "")
        {
            var content = HttpGet(host, ApiUrl(url, null), param);
            return content;
        }

        public string ApiHttpPost(string host, string url, Dictionary<string, object> param, string logFileName = "")
        {
        ...
        protected string HttpGet(string host, string url, Dictionary<string, object> param)
        {
        ...
        protected string HttpPost(string host, string url, Dictionary<string, object> param)
        {
            return NormalHttp(host, url, param, Method.POST);
        }

        protected string NormalHttp(string host, string url, Dictionary<string, object> param, Method method)
        {
