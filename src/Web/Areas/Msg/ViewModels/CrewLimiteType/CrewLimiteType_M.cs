...
namespace Web.Areas.Msg.ViewModels.CrewLimiteType
{
    public class CrewLimiteType_M
    {
        ...
        public static CrewLimiteType_M ToViewModel(crew_limite_type crewlimitetype)
        {
            return new CrewLimiteType_M()
            {
