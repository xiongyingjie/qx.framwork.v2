...
{
    public class RProductController : BaseOrderController,ICrud<RProduct_M>
    {

        private IRepository<r_product> _repository;
        public RProductController( IRepository<r_product> repository)
        {
        ...
        public ActionResult Index(string ReportID, string Params, int pageIndex = 1, int perCount = 10)
        {
            ...
            {
                return RedirectToAction("Index", new { ReportID = "Djk.Order.产品", Params = Params });
            }
        ...
        [HttpPost]
        public ActionResult Create(RProduct_M viewModel)
        {
            try
            {
        ...
        [HttpPost]
        public ActionResult Edit(RProduct_M viewModel)
        {
            try
            {
                if (ModelState.IsValid)
