...
{
    public class SellConsultantController : BaseOrderController,ICrud<SellConsultant_M>
    {

        private IRepository<sell_consultant> _repository;
        public SellConsultantController( IRepository<sell_consultant> repository)
        {
        ...
        public ActionResult Index(string ReportID, string Params, int pageIndex = 1, int perCount = 10)
        {
            ...
            {
                return RedirectToAction("Index", new { ReportID = "Djk.Order.售卖咨询", Params = Params });
            }

            //初始化报表
            InitReport("售卖咨询", "#","",true,"");
            return View();
        }
        ...
        [HttpPost]
        public ActionResult Create(SellConsultant_M viewModel)
        {
            try
            {
        ...
        [HttpPost]
        public ActionResult Edit(SellConsultant_M viewModel)
        {
            try
            {
                if (ModelState.IsValid)
