...
{
    public class OrderStateController : BaseOrderController,ICrud<OrderState_M>
    {

        private IRepository<order_state> _repository;
        public OrderStateController( IRepository<order_state> repository)
        {
        ...
        public ActionResult Index(string ReportID, string Params, int pageIndex = 1, int perCount = 10)
        {
            ...
            {
                return RedirectToAction("Index", new { ReportID = "Djk.Order.订单状态", Params = Params });
            }

            //初始化报表
            InitReport("订单状态", "#","",true,"");
            return View();
        }
        ...
        [HttpPost]
        public ActionResult Create(OrderState_M viewModel)
        {
            try
            {
        ...
        [HttpPost]
        public ActionResult Edit(OrderState_M viewModel)
        {
            try
            {
                if (ModelState.IsValid)
