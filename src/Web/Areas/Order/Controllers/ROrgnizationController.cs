...
{
    public class ROrgnizationController : BaseOrderController,ICrud<ROrgnization_M>
    {

        private IRepository<r_orgnization> _repository;
        public ROrgnizationController( IRepository<r_orgnization> repository)
        {
        ...
        public ActionResult Index(string ReportID, string Params, int pageIndex = 1, int perCount = 10)
        {
            ...
            {
                return RedirectToAction("Index", new { ReportID = "Djk.Order.组织机构", Params = Params });
            }

            //初始化报表
            InitReport("组织机构", "#","",true,"");
            return View();
        }
        ...
        [HttpPost]
        public ActionResult Create(ROrgnization_M viewModel)
        {
            try
            {
        ...
        [HttpPost]
        public ActionResult Edit(ROrgnization_M viewModel)
        {
            try
            {
                if (ModelState.IsValid)
